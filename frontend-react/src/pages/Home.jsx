...
// useTheme not needed here – Header handles theme toggle
      ...
      <main id="app" className="vrs-theme-scope min-h-screen">
        ...
        <section className="home-hero-shell relative min-h-screen overflow-x-hidden bg-[#F2F3F1] lg:h-screen lg:overflow-hidden">
          ...
          <img loading="lazy" src="/assets/images/car-transparent.png"
            alt="RS Self Drive Nepal - Premium SUV Car Rental Kathmandu Banasthali AS Mobility" width="1600" height="1221" decoding="async"
              ...
              <div className="home-hero-card relative z-20 w-full opacity-0 animate-floatIn lg:w-[54%]">
                <div className="home-hero-card-panel rounded-md bg-[#F5F6F4] p-5 opacity-0 translate-y-5 transition duration-300 hover:-translate-y-[2px] hover:shadow-[0_18px_34px_rgba(12,35,38,0.1)] animate-fadeUp sm:p-6 lg:p-8">
                  <h1 className="max-w-[760px] text-[34px] font-bold leading-[1.1] tracking-[-0.02em] text-ink sm:text-[40px] lg:text-[66px]">
                    RS Self Drive Nepal - #1 Car Rental in Kathmandu
                  </h1>
                  <p className="mt-4 max-w-[790px] text-[14px] leading-[1.55] text-[#3E4448] opacity-0 translate-y-5 animate-fadeUp sm:text-[15px] lg:text-[16px] [animation-delay:90ms]">
                    Nepal's premier self-drive car rental service. Rent cars, SUVs, luxury vehicles in Kathmandu, Pokhara, Chitwan with AS Mobility. 
        ...
        <section className="bg-[#EDEEE9] dark:bg-[#1a2228]" style={{padding:'72px 24px 80px'}}>
          <div style={{maxWidth:'1100px',margin:'0 auto'}}>
            <AnimatedSection animation="fadeUp" className="text-center" style={{marginBottom:'56px'}}>
            ...
            <div className="hiw-steps">
              {/* Step 1 */}
              <AnimatedSection animation="fadeUp" delay={0} className="hiw-step">
              ...
              {/* Step 2 */}
              <AnimatedSection animation="fadeUp" delay={150} className="hiw-step">
              ...
              {/* Step 3 */}
              <AnimatedSection animation="fadeUp" delay={300} className="hiw-step">
                <div className="dark:bg-[#1a5c52]" style={{width:'88px',height:'88px',borderRadius:'22px',background:'#1a5c52',display:'flex',alignItems:'center',justifyContent:'center',transition:'transform 0.3s,box-shadow 0.3s',cursor:'pointer'}}>
                  <svg width="40" height="40" viewBox="0 0 24 24" className="fill-white" xmlns="http://www.w3.org/2000/svg">
          ...
          <div style={{maxWidth:'1100px',margin:'0 auto',textAlign:'center'}}>
            ...
            {vehicles.length > 0 ? (
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6" style={{maxWidth:'1100px',margin:'0 auto'}}>
                {vehicles.map((v, idx) => (
                  <AnimatedSection key={v.id} animation="fadeUp" delay={idx * 100}>
                  <div onClick={() => navigate(`/vehicles/${toSlug(v.brand, v.name)}`)}
                    ...
                    <div className="p-4">
                      ...
                      <div className="mt-3 flex items-center justify-between">
                        ...
                        <button onClick={(e) => { e.stopPropagation(); navigate(`/booking?vehicle=${v.id}`); }}
          ...
          <div style={{maxWidth:'1200px',margin:'0 auto'}}>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              ...
              <div className="space-y-4">
                  ...
                  {/* Many Locations */}
                  <AnimatedSection animation="fadeRight" delay={120}>
                  <div className="flex items-start gap-4 p-4 rounded-2xl bg-white dark:bg-[#253035] shadow-[0_4px_20px_rgba(0,0,0,0.08)]">
                    <div className="flex-shrink-0 w-14 h-14 rounded-2xl bg-[#E8EFED] dark:bg-[#1f403f] flex items-center justify-center">
                      <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="#1f5b57" strokeWidth="1.5" className="dark:stroke-[#5bbfb5]">
                  ...
                  {/* Free Cancellation */}
                  <AnimatedSection animation="fadeRight" delay={240}>
                  <div className="flex items-start gap-4 p-4 rounded-2xl bg-white dark:bg-[#253035] shadow-[0_4px_20px_rgba(0,0,0,0.08)]">
                    <div className="flex-shrink-0 w-14 h-14 rounded-2xl bg-[#E8EFED] dark:bg-[#1f403f] flex items-center justify-center">
                      <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="#1f5b57" strokeWidth="1.5" className="dark:stroke-[#5bbfb5]">
                        <circle cx="12" cy="12" r="10"/>
          ...
          <div style={{maxWidth:'1100px',margin:'0 auto'}}>
            <AnimatedSection animation="fadeUp">
              <h2 className="text-[#1a2a2f] dark:text-slate-100 text-center" style={{fontFamily:"'Poppins',sans-serif",fontSize:'32px',fontWeight:700,margin:'0 0 40px'}}>
                About RS Self Drive Nepal - AS Mobility
              </h2>
            </AnimatedSection>
              ...
              <div className="grid gap-8 lg:grid-cols-2">
                <div>
                  ...
                  <p className="text-[#6C7074] dark:text-slate-400 text-[14px] leading-[1.7] mb-4">
                    Welcome to <strong>RS Self Drive Nepal</strong> (also known as <strong>AS Mobility</strong>), Nepal's premier self-drive car rental service based in Banasthali, Kathmandu. 
                ...
                <div>
                  <h3 className="text-[#1f5b57] dark:text-[#5bbfb5] font-bold text-[18px] mb-3">Why Choose RS Self Drive?</h3>
            ...
            <AnimatedSection animation="fadeUp" delay={200}>
              <div className="mt-10 pt-8 border-t border-[#E8EBE6] dark:border-white/[0.08]">
                <h3 className="text-[#1a2a2f] dark:text-slate-100 font-bold text-[18px] mb-4 text-center">
                  Car Rental Services Across Nepal
                </h3>
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4 text-center">
                  <div className="p-4 rounded-xl bg-white dark:bg-[#1c2a2e] shadow-sm">
                    <p className="font-bold text-[#1f5b57] dark:text-[#5bbfb5]">Kathmandu</p>
                    <p className="text-[12px] text-[#6C7074] dark:text-slate-400">Banasthali & City-wide</p>
                  </div>
                  <div className="p-4 rounded-xl bg-white dark:bg-[#1c2a2e] shadow-sm">
                    <p className="font-bold text-[#1f5b57] dark:text-[#5bbfb5]">Pokhara</p>
                    <p className="text-[12px] text-[#6C7074] dark:text-slate-400">Lakeside & Airport</p>
                  </div>
                  <div className="p-4 rounded-xl bg-white dark:bg-[#1c2a2e] shadow-sm">
                    <p className="font-bold text-[#1f5b57] dark:text-[#5bbfb5]">Chitwan</p>
                    <p className="text-[12px] text-[#6C7074] dark:text-slate-400">Sauraha & Bharatpur</p>
                  </div>
                  <div className="p-4 rounded-xl bg-white dark:bg-[#1c2a2e] shadow-sm">
                    <p className="font-bold text-[#1f5b57] dark:text-[#5bbfb5]">Lumbini</p>
                    <p className="text-[12px] text-[#6C7074] dark:text-slate-400">Buddha Birthplace</p>
                  </div>
                </div>
                <p className="text-center text-[12px] text-[#6C7074] dark:text-slate-400 mt-4">
                  Contact: +977 970-452-0781 | Email: info@rsselfdrive.com | Location: Banasthali, Kathmandu, Nepal
                </p>
              </div>
            </AnimatedSection>
          </div>
