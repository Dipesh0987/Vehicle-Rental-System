    ...
    return `
      <footer class="vrs-footer vrs-theme-scope relative mt-20 bg-[#e8e6df] dark:bg-slate-900">
        ...
        <div class="relative z-10 mx-auto w-full max-w-[1200px] px-4 py-12 sm:px-6 lg:px-8">
          <div class="grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-[2fr_1.2fr_1fr_1.5fr] lg:gap-16">
            ...
            <div>
              <h3 class="mb-5 text-[15px] font-bold text-slate-800 dark:text-slate-100">Contact Info</h3>
              <ul class="space-y-4">
            ...
            <div>
              ...
              <form class="mb-6" onsubmit="event.preventDefault(); alert('Newsletter subscription coming soon!');">
                <div class="flex gap-2">
                  <input 
                    ...
                    required
                    class="flex-1 rounded-md border border-slate-300 bg-white px-3 py-2 text-[13px] text-slate-700 placeholder:text-slate-400 outline-none transition focus:border-[#ff6b35] focus:ring-2 focus:ring-[#ff6b35]/20 dark:border-slate-600 dark:bg-slate-800 dark:text-slate-200 dark:placeholder:text-slate-500"
                  />
                  <button 
                    type="submit" 
                    class="whitespace-nowrap rounded-md bg-[#ff6b35] px-5 py-2 text-[13px] font-semibold text-white shadow-sm transition hover:bg-[#ff5722] hover:shadow-md active:scale-95"
                  >
                    Submit
                  </button>
                </div>
              ...
              <div class="flex items-center gap-2.5">
                <a href="#" class="flex h-9 w-9 items-center justify-center rounded-full border border-slate-300 bg-white text-slate-500 transition hover:border-[#1877f2] hover:bg-[#1877f2] hover:text-white dark:border-slate-600 dark:bg-slate-800 dark:text-slate-400" aria-label="Facebook">
                  <svg class="h-4 w-4" fill="currentColor" viewBox="0 0 24 24"><path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/></svg>
                </a>
                <a href="#" class="flex h-9 w-9 items-center justify-center rounded-full border border-slate-300 bg-white text-slate-500 transition hover:border-[#E4405F] hover:bg-gradient-to-br hover:from-[#f09433] hover:via-[#e6683c] hover:to-[#bc1888] hover:text-white dark:border-slate-600 dark:bg-slate-800 dark:text-slate-400" aria-label="Instagram">
                ...
                <a href="#" class="flex h-9 w-9 items-center justify-center rounded-full border border-slate-300 bg-white text-slate-500 transition hover:border-[#FF0000] hover:bg-[#FF0000] hover:text-white dark:border-slate-600 dark:bg-slate-800 dark:text-slate-400" aria-label="YouTube">
                ...
                <a href="#" class="flex h-9 w-9 items-center justify-center rounded-full border border-slate-300 bg-white text-slate-500 transition hover:border-[#1DA1F2] hover:bg-[#1DA1F2] hover:text-white dark:border-slate-600 dark:bg-slate-800 dark:text-slate-400" aria-label="Twitter">
