  ...
  return (
    <footer className="vrs-footer vrs-theme-scope relative mt-20 bg-[#e8e6df] dark:bg-slate-900">
          ...
          <div className="max-w-[280px]">
            <div className="mb-4">
              <h2 className="text-[28px] font-black leading-none tracking-tight">
                ...
                <span className="text-slate-800 dark:text-slate-100">Self</span>
              </h2>
      ...
      <div className="border-t border-slate-300/50 py-6 dark:border-slate-700">
        <p className="text-center text-[12px] text-slate-500 dark:text-slate-400">Copyright &copy;{year} <span className="text-[#E58C4E] font-semibold">AS</span><span className="font-semibold">Self</span>. All rights reserved</p>
      </div>
    </footer>
  );
}
