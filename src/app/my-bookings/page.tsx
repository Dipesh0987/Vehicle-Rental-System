  ...
  return (
    <div className="vrs-page min-h-screen bg-white font-poppins">
      <main id="app" className="vrs-theme-scope min-h-screen">
        <Header />
        <div className="mx-auto w-[95%] max-w-[1390px] pb-14 pt-6">
      <div className="mb-6 flex flex-wrap items-end justify-between gap-3">
        ...
        <Link href="/vehicles" className="rounded-full border border-[#d0dbd6] bg-white px-4 py-2 text-[13px] font-semibold text-[#264447] transition hover:-translate-y-[1px]">
          Browse Vehicles
        </Link>
      </div>
      ...
      {loading ? (
        ...
        <div className="rounded-[24px] border border-[rgba(23,57,60,0.12)] bg-white/80 p-10 text-center shadow-sm">
          ...
          <Link href="/vehicles" className="mt-4 inline-block rounded-full bg-accent px-6 py-3 text-[13px] font-semibold text-white transition hover:-translate-y-[1px] hover:brightness-105">
            Book a Vehicle
          </Link>
        </div>
      ) : (
                ...
                <div className="flex flex-col sm:flex-row">
                  ...
                  <div className="flex-1 p-4 sm:p-5">
                    ...
                    <div className="mt-3 flex flex-wrap gap-2">
                      ...
                      {b.status === 'confirmed' && (
                        <button onClick={() => router.push(`/modify-booking?id=${b.id}`)}
