...
export default function Contact() {
  ...
  const focusField = (key: string) => {
    ...
    const el = document.getElementById(`contactfield-${key}`) as HTMLElement | null;
    if (el) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (Object.keys(newErrors).length > 0) {
      ...
      if (firstKey) { focusField(firstKey); toast.error(newErrors[firstKey]); }
      return;
    }
  ...
  return (
    <div className="vrs-page min-h-screen bg-white font-poppins">
      ...
      <div className="vrs-theme-scope bg-[#F2F3F1] dark:bg-[#0f171a] px-5 pt-12 pb-16 md:px-6 md:pt-16 md:pb-20">
            ...
            {submitted ? (
              ...
              <form onSubmit={handleSubmit}>
                <div className="mb-5">
                  ...
                  <input id="contactfield-name" type="text" value={form.name} onChange={(e) => {
                ...
                <div className="mb-5">
                  ...
                  <input id="contactfield-email" type="email" value={form.email} onChange={update('email')} placeholder="your@email.com" required className={inputCls} />
                ...
                <div className="mb-5">
                  ...
                  <input id="contactfield-subject" type="text" value={form.subject} onChange={update('subject')} placeholder="How can we help?" required className={inputCls} />
                ...
                <div className="mb-5">
                  ...
                  <textarea id="contactfield-message" value={form.message} onChange={update('message')} placeholder="Tell us more about your inquiry..." rows={5} required className={`${inputCls} resize-none min-h-[120px]`} />
        ...
        <div className="mx-auto max-w-[1200px] px-5 pb-12 md:px-6 md:pb-16 mt-10">
